...
const inputOptions = [
  { id: 1, name: "email", labelName: "Email", type: "email" },
  { id: 2, name: "password", labelName: "Password", type: "password" },
];
let initialValues = {
  email: "",
  password: "",
    ...
    <div className="flex justify-center items-center mt-2">
      <div className="flex justify-center items-center mt-2 p-4  w-1/3 rounded-lg shadow-lg shadow-purple-400 border   ">
        ...
        >
          ...
          <Link to={"/signup"}>
            <p className="text-xs text-blue-600 font-bold">Not Signup Yet ?</p>
          </Link>
        </form>
      </div>
    </div>
